...
<?= $this->section('dashboard_content'); ?>
    <div class="row row-cols-1 row-cols-md-2 g-4" data-masonry='{"percentPosition": true }'>
        ...
        <div class="col">
            <div class="card">
                <div class="card-header d-flex justify-content-between align-items-center">
                    <h6 class="m-0">Feedback & Komentar</h6>
                    <div class="dropdown">
                        <button class="btn btn-sm btn-primary dropdown-toggle" type="button" data-bs-toggle="dropdown" aria-expanded="false">
                            <i class="fa-solid fa-gears"></i>
                            <span class="me-2">Akses Cepat</span>
                    ...
                    <ul class="list-group list-group-flush">
                        <li class="list-group-item p-2">
                            <div class="d-flex justify-content-between align-items-center">
                                <h6 class="m-0">Nama Pengunjung</h6>
                                <small>3 hari yang lalu</small>
                            </div>
                            <p class="fs-6 m-0">
                                Lorem ipsum dolor sit amet consectetur, adipisicing elit. Odio non quae, nobis perspiciatis
                                nostrum minus quos doloremque ab delectus fugiat reiciendis sint natus nihil molestias suscipit
                                minima assumenda adipisci nemo.
                            </p>
                        </li>
                        <li class="list-group-item p-2">
                            <div class="d-flex justify-content-between align-items-center">
            ...
            <div class="card">
                <div class="card-header d-flex justify-content-between align-items-center">
                    ...
                    <button class="btn btn-sm btn-primary">
                        <i class="fa-solid fa-gears"></i>
                        <span class="me-2">Lihat Aktivitas</span>
                    </button>
                </div>
                <div class="card-body p-2">
                    <ul class="list-group list-group-flush">
                        <?php if (!empty($log_akun)): ?>
                            <?php foreach($log_akun as $log): ?>
                                <li class="list-group-item p-2">
                                    <strong>
