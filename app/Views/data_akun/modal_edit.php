<!-- Modal Edit Data -->
<div class="modal fade" id="edituser<?= $akun['id_user']?>" tabindex="-1" aria-labelledby="edituserLabel" aria-hidden="true">
    <div class="modal-dialog">
        <form class="modal-content needs-validation" action="/data_akun/update" method="post" autocomplete="off" novalidate>
            <?= csrf_field(); ?>
            <div class="modal-header">
                <h1 class="modal-title fs-5" id="edituserLabel">Edit Data Akun</h1>
